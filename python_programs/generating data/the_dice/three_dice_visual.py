...
data = [Bar(x=x_values,y=frec, marker=dict(color='rgba(192, 237, 166, 0.6)',line=dict(color='rgba(255, 247, 188, 1.0)', width=3)))]

x_axis_config = {'title':'Result', 'dtick':1}
y_axis_config = {'title':'Frecuency of Individual Value'}

my_hist = Layout(title='Output of Rolling Three 6-Sided Dice 51500 Times',title_x=0.5, xaxis = x_axis_config, yaxis = y_axis_config)
